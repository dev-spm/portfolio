      ...
      <div className="flex flex-col w-full h-full md:w-1/2">
        <div>
          ...
          <p className="sm:text-lg lg:text-xl">
            Tienda online creada usando
            <a className="font-bold bg-gradient-to-r from-red-800 to-red-300 text-transparent bg-clip-text"> Python/Django </a>
            y
            <a className="font-bold bg-gradient-to-r from-red-800 to-red-300 text-transparent bg-clip-text"> React + Bootstrap</a>
            .
          </p>
        </div>
        <div className="mt-5">
          <button className="rounded-lg px-5 py-1 bg-gray-500 hover:text-red-400 hover:bg-gray-700">
            <a href="https://github.com/dev-spmanuel/e-commerce-dai" target="_blank" rel="noopener noreferrer" className="font-bold">
